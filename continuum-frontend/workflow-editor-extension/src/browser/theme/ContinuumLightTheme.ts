import { MonacoThemeJson } from "@theia/monaco/lib/browser/monaco-theming-service";

export const ContinuumLightTheme: MonacoThemeJson = {
    id: "continuum-light",
    label: "Continuum (Light)",
    description: "Continuum Light Theme",
    uiTheme: "vs",
    json: {
